...
class EditGoodie extends Component {
    constructor(props) {
        ...
        this.editGoodie = this.editGoodie.bind(this)
    ...
    handleSubmit(event) {
        ...
        fetch (`https://hannahs-goodies-api.herokuapp.com/update_goodie/${id}`, {
            method: 'PUT',
            headers: {
    ...
    render() {
        return(
            <div className = ''>
                <button onClick = {this.editGoodie}>Update This Goodie</button>
